...
# -----------------------------
VARIANT="${VARIANT:-target_plus_kg}"
KG_SOURCE_KEY_RAW="${KG_SOURCE_KEY:-grace}"
KG_METHOD="${KG_METHOD:-mean_decay}"
KG_HOPS="${KG_HOPS:-2}"
KG_RELATION_LIMIT="${KG_RELATION_LIMIT:-2}"   # use 'all' for no explicit cap
KG_PATH_MAX_PATHS="${KG_PATH_MAX_PATHS:-32}"
...
GAT_HIDDEN_DIM="${GAT_HIDDEN_DIM:-128}"
